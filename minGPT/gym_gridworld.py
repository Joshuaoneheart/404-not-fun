...
class GymGridWorld(gym.Env):
    ...
    def __init__(
        ...
        self.observation_space = spaces.Box(0, 1, (22, ), dtype=int)
    ...
    def step(self, action: int) -> tuple:
        ...
        if self.__is_goal_state(state_coord):
            ...
            return next_init_state, self.__goal_reward, True, False, {}
        if self.__is_trap_state(state_coord):
            next_init_state = self.reset()
            return next_init_state, self.__trap_reward, True, False, {}
        ...
        state = np.zeros((22,))
        state[next_state] = 1
        return state, self.__step_reward, False, False, {}
